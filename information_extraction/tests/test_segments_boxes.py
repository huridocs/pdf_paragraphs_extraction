...
from information_extraction.SegmentsBoxes import SegmentsBoxes, SegmentBox
...
class TestDocument(TestCase):
    def test_from_information_extraction(self):
        xml_string = '<?xml version="1.0" encoding="utf-8"?>\
                        ...
                        <Page HEIGHT="1" ID="Page1" PHYSICAL_IMG_NR="1" WIDTH="1">\
                        ...
                        <Page HEIGHT="1" ID="Page2" PHYSICAL_IMG_NR="2" WIDTH="1">\
    ...
    def test_to_json(self):
        segments_boxes = SegmentsBoxes([SegmentBox(1, 2, 3, 4, 1), SegmentBox(0.1, 0.2, 0.3, 0.4, 2)])
        json_result = '[{"left": 1, "top": 2, "width": 3, "height": 4, "pageNumber": 1}, ' \
